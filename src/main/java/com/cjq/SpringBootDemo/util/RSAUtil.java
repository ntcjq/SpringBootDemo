...
public class RSAUtil {
    ...
    /** 指定公钥存放文件 */
    private static String PUBLIC_KEY_FILE = "D:\\rsa_publicKey.txt";
    /** 指定私钥存放文件 */
    private static String PRIVATE_KEY_FILE = "D:\\rsa_privateKey.txt";
    ...
    public static void main(String[] args) {
        try {
            ...
            String str = "我是签名";
            String sign =  sign(str.getBytes("UTF-8"),getprivatekey());
            System.out.println("签名："+sign);
            System.out.println("验证签名："+verify(str.getBytes("UTF-8"),getpublickey(),sign));
